                            ...
                            idaredəkiFirmalar.forEach(item => {
                                ...
                                for(const nomre in item.decls) {
                                    ...
                                    if (matchedRecord) {
                                        ...
                                        if (mainBildirisNo) {
                                            bildirisStatus = `<span style="color: #166534; font-size:11px; font-weight:700; margin-right: 12px;"><i class="fa-solid fa-check"></i> Bil. №: ${mainBildirisNo}</span>`;
                                    ...
                                    if (matchedRaport) {
                                        ...
                                        if (mainRaportNo) {
                                            ...
                                            // Əgər raport nömrəsi artırmaq üçün xüsusi paneliniz varsa, onun funksiyasını bura yaza bilərsiniz
                                ...
                                // Raport bloklama məntiqi
                                let canRaport = true;
                                let missingBildirisDeclsForRaport = [];
                                newRaportDecls.forEach(gb => {
                                    ...
                                    if (!matched) {
                                        canRaport = false;
                                        missingBildirisDeclsForRaport.push(gb);
                                    }
                                });
                                ...
                                let statusBadge = "";
                                let fullCompletedHtml = "";
                                
                                if (completedDecls === totalDecls && totalDecls > 0) {
                                    fullCompletedHtml = `<div style="margin: 10px 16px 16px 16px; background:#dcfce7; color:#166534; padding:12px 16px; border-radius:8px; border:1px solid #86efac; font-size:13px; font-weight:700; display:flex; align-items:center; gap:8px;"><i class="fa-solid fa-circle-check" style="font-size:18px;"></i> Bu firma üzrə bütün Bildiriş və Raportlar bazada tam qeydə alınıb.</div>`;
                                    ...
                                    statusBadge = `<div class="badge-pill" style="background:#dbeafe; color:#1d4ed8; border-color:#bfdbfe;"><i class="fa-solid fa-sparkles"></i> Yeni Qeyd</div>`;
                                }
